<div>
    ...
    <div class="relative bg-white rounded-lg max-w-md p-6 shadow-lg">
        ...
        <div class="flex justify-end">
            <button wire:click="delete"
                class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 mr-2 font-medium transition-all ease-in-out duration-300">Delete</button>
