        ...
        <div class="flex justify-between h-[70px]">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-10">
                    <button @click="close = ! close" :class="{'invisible absolute': ! close, 'visible': close }" class="hidden invisible sm:block pb-[3px]" type="button">
                    ...
                    <a href="{{ route('dashboard') }}" class="block sm:hidden">
                        ...
                        <img class="block cursor-pointer" src="{{asset('resources/img/Logo.png')}}" alt="logo">
                    </a>
